...
j = updater.job_queue
data = requests.get('https://jeemain.nta.nic.in/webinfo/public/home.aspx',headers={'User-Agent': 'Mozilla/5.0'}).content
...
def start(update,context):
    ...
    if new_id in groups:
        ...
        with open('groups.dat','a') as f:
            f.write(str(new_id))
            f.write('\n')
        context.bot.send_message(chat_id=update.effective_chat.id, text='Task completed successfullyi. I\'ll inform you whenever the website changes. To view if I\'m running, type /start')
